...
## 🔑 핵심 구현
- 답변 가중치 산정 방식을 활용한 유저 맞춤형 결과 유형 매칭 로직 구현
- html2canvas 라이브러리를 활용하여 결과 페이지를 이미지 파일로 캡처 ∙ 저장 기능 구현
- Kakao SDK를 연동하여 테스트 결과 링크 공유 기능 적용
- CSS Keyframes 애니메이션을 적용하여 결과 도출 단계의 자연스러운 화면 전환 효과 연출
<br>
